...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    20,   24,    3,    4,    1,    2,   19,    5,   18,    1,
 /*    10 */     2,   16,   23,   19,    6,    7,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,    6,    2,    3,    4,    5,    8,    6,    7,    4,
 /*    10 */     5,    1,    6,    8,    6,    6,    8,    8,    6,    6,
 /*    20 */     6,    6,
};
...
static const YYCODETYPE yyRuleInfoLhs[] = {
     7,  /* (0) program ::= expr */
     6,  /* (1) expr ::= expr MINUS expr */
     6,  /* (2) expr ::= expr PLUS expr */
     6,  /* (3) expr ::= expr TIMES expr */
     6,  /* (4) expr ::= expr DIVIDE expr */
     6,  /* (5) expr ::= NUM */
};
...
#line 27 "calc2.y"
{
    printf ("Token.value: %d\nToken.n: %d\n",
            yymsp[0].minor.yy0.value, yymsp[0].minor.yy0.n);
}
#line 828 "calc2.c"
        break;
...
#line 32 "calc2.y"
{
    ...
    yylhsminor.yy0.n = yymsp[-2].minor.yy0.n+1 + yymsp[0].minor.yy0.n+1;
}
#line 836 "calc2.c"
...
#line 56 "calc2.y"
{
    ...
    yylhsminor.yy0.n = yymsp[0].minor.yy0.n+1;
}
#line 876 "calc2.c"
